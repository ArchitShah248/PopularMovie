 ...
 */
public interface MovieFavouritesColumns {
    ...
    @DataType(DataType.Type.TEXT) @NotNull public static final String BACKDROP_PATH = "backdrop_path";
    ...
    @DataType(DataType.Type.INTEGER) @NotNull public static final String VIDEO = "video";
    ...
    @DataType(DataType.Type.INTEGER) @NotNull public static final String ADULT = "adult";
    ...
    @DataType(DataType.Type.TEXT) @NotNull public static final String GENRE_IDS = "genre_ids";
